...
<div class="kt-portlet kt-portlet--mobile">
	<div class="kt-portlet__head kt-portlet__head--lg">
      ...
      <span class="kt-portlet__head-icon"><i class="fab fa-gg-circle"></i></span>
			<h3 class="kt-portlet__head-title">All Deposit Information</h3>
		</div>
		<div class="kt-portlet__head-toolbar">
			<div class="kt-portlet__head-wrapper">
				<div class="kt-portlet__head-actions">
                    @can('insert_journal')
					<a href="{{route('deposit')}}" class="btn btn-brand btn-elevate btn-icon-sm"><i class="fa fa-plus-circle"></i>Add Deposit</a>
                    @endcan
				</div>
			</div>
		</div>
			...
			<tbody>
                ...
                @foreach($all as $data)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('deposit.show',$data->id)}}" class="text-dark manage_btn_icon" title="view"><i class="fa fa-plus-square"></i></a>
                                
                                <a href="{{route('deposit.edit',$data->id)}}" class="text-info manage_btn_icon" title="edit"><i class="fa fa-pen-square"></i></a>
