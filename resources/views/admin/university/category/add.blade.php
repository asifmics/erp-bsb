...
<div class="kt-portlet kt-portlet--mobile">
	<form class="kt-form kt-form--label-right" method="post" action="{{url('dashboard/university/program/category/submit')}}" enctype="multipart/form-data">
		@csrf
		<div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label">
	      <span class="kt-portlet__head-icon"><i class="fab fa-gg-circle"></i></span>
				<h3 class="kt-portlet__head-title">Add University Program Category Information</h3>
			</div>
        ...
        <script type="text/javascript">
            swal({title: "Success!", text: "Successfully add university program category information!", icon: "success", button: "OK", timer:5000,});
         </script>
      @endif
