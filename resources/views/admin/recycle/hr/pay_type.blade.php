...
<div class="kt-portlet kt-portlet--mobile">
	<div class="kt-portlet__head kt-portlet__head--lg">
      ...
      <span class="kt-portlet__head-icon"><i class="fab fa-gg-circle"></i></span>
			<h3 class="kt-portlet__head-title">All Pay Type RecycleBin</h3>
		</div>
			...
			<tbody>
				...
				<tr>
					...
					<td>
                        ...
                        <a href="#" id="restore" class="text-danger manage_btn_icon" title="delete" data-toggle="modal" data-target="#RestoreModal" data-id="{{$payType->id}}"><i class="fa fa-undo"></i></a>
					</td>
				</tr>
				@empty
