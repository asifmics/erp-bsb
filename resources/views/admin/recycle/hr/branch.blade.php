...
<div class="kt-portlet kt-portlet--mobile">
	<div class="kt-portlet__head kt-portlet__head--lg">
      ...
      <span class="kt-portlet__head-icon"><i class="fab fa-gg-circle"></i></span>
			<h3 class="kt-portlet__head-title">All Branch RecycleBin</h3>
		</div>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<a href="#" id="restore" class="text-danger manage_btn_icon" title="delete" data-toggle="modal" data-target="#RestoreModal" data-id="{{$branch->id}}"><i class="fa fa-undo"></i></a>
					</td>
				</tr>
				@empty
...
<div class="modal fade" id="RestoreModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
				<form method="post" action="{{route('restore.branch')}}">
					@csrf
