...
<div class="kt-portlet kt-portlet--mobile">
    <form class="kt-form kt-form--label-right" method="post" action="{{route('save_department')}}"
        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    ...
                    @if (Request::is('dashboard/hr/department/create'))
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        @can('all_department')
                        <a href="{{route('all_department')}}" class="btn btn-brand btn-elevate btn-icon-sm"><i class="fa fa-th"></i>All Department</a>
                        @endcan
                    </div>
                </div>
            </div>
