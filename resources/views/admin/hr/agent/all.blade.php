...
<div class="kt-portlet kt-portlet--mobile">
	<div class="kt-portlet__head kt-portlet__head--lg">
      ...
      <span class="kt-portlet__head-icon"><i class="fab fa-gg-circle"></i></span>
			<h3 class="kt-portlet__head-title">All Agetn Information</h3>
		</div>
		<div class="kt-portlet__head-toolbar">
			<div class="kt-portlet__head-wrapper">
				<div class="kt-portlet__head-actions">
					<a href="{{route('add_employee')}}" class="btn btn-brand btn-elevate btn-icon-sm"><i class="fa fa-plus-circle"></i>Add Agent</a>
				</div>
			</div>
		</div>
	</div>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<a href="{{route('edit_employee', $employee->slug)}}" class="text-info" title="edit"><i class="fa fa-pen-square fa-2x"></i></a>
