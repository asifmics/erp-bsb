            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                     <div class="kt-portlet__head-actions">
                        ...
                        <a href="{{route('report_active_employees_excel')}}" class="btn btn-success btn-elevate btn-icon-sm"><i class="fa fa-file-excel"></i>Excel</a>
                         <a href="{{route('report_active_employees_pdf')}}" class="btn btn-youtube btn-elevate btn-icon-sm"><i class="fa fa-file-pdf"></i>PDF</a>
