...
<head>
    <meta charset="UTF-8">
    <title>All Visitor Information</title>
<style>
...
<body style="margin: 0; padding: 0;">
   ...
   <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="1" align="center">
        ...
        <tr>
            <td colspan="7" height="20" style="text-align: center">
                <span style="margin: 0; color: #000; font-size: 12px; font-family: sans-serif; text-transform: capitalize;">Name: {{ $receptionsit->name }} || EMP-ID: {{ $receptionsit->id_no }}</span>
            </td>
        </tr>
        <tr>
        ...
        @if ($receptionsit->receptionist_student != "")
        @php
            $i = 1;
        @endphp
        @foreach ($receptionsit->receptionist_student as $student)
          <tr>
