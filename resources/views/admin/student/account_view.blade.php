            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="admission-form">
                        ...
                        <div class="row" >
                            <div style="padding: 0px; margin =0px"  class="col-md-3 col-sm-6 col-xs-12">
                                <div class="item form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                    <label for="name">Name <span class="required"></span>
                                    </label>
                                    <input type="hidden" name="student_id" value="{{ $student->id }}">
                                    <input class="form-control col-md-11 col-xs-12" name="name" id="name" value="{{ $student->name ?? "" }}" placeholder="Name" type="text" autocomplete="off">
                            ...
                            <div style="padding: 0px; margin =0px"  class="col-md-3 col-sm-6 col-xs-12">
                                <div class="item form-group {{ $errors->has('id_no') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control col-md-11 col-xs-12" name="id_no" disabled id="name" value="{{ $student->visitor_id ?? "" }}" placeholder="ID number" type="text" autocomplete="off">
                                    <div class="help-block"></div>
                                     @if ($errors->has('id_no'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div style="padding: 0px; margin =0px"  class="col-md-3 col-sm-6 col-xs-12">
                                <div class="item form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control col-md-11 col-xs-12" name="email" id="email" value="{{ $student->email ?? "" }}" placeholder="Email" type="email" autocomplete="off">
                                    <div class="help-block"></div>
                                     @if ($errors->has('email'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div style="padding: 0px; margin =0px"  class="col-md-3 col-sm-6 col-xs-12">
                                <div class="item form-group {{ $errors->has('phone') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control col-md-11 col-xs-12" name="phone" id="phone" value="{{ $student->phone ?? "" }}" placeholder="Phone" type="text" autocomplete="off">
                                    <div class="help-block"></div>
                                     @if ($errors->has('phone'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            {{-- <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="item form-group {{ $errors->has('national_id') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control col-md-11 col-xs-12" name="national_id" id="national_id" value="{{ $student->nid ?? "" }}" placeholder="National ID" type="text" autocomplete="off">
                                    <div class="help-block"></div>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="item form-group {{ $errors->has('nationality') ? ' has-error' : '' }}">
                                    ...
                                    @endphp
                                    <select name="nationality" id="" class="form-control col-md-11 col-xs-12">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="item form-group {{ $errors->has('dob') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control col-md-11 col-xs-12" id="kt_datepicker_1" name="dob" id="dob" value="{{ $student->dob ?? "" }}" placeholder="Birth Date" type="text" autocomplete="off">
                                    <div class="help-block"></div>
                                     @if ($errors->has('dob'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="item form-group {{ $errors->has('gender') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control col-md-11 col-xs-12" name="gender" id="gender" >
                            ...
                            {{-- <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="item form-group {{ $errors->has('blood_group') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control col-md-11 col-xs-12" name="blood_group" id="blood_group">
                                        <option value="">--Select--</option>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="item form-group {{ $errors->has('add_religion') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control col-md-11 col-xs-12" name="religion" id="add_religion" value="{{ $student->religion ?? "" }}" placeholder="Religion" type="text" autocomplete="off">
                                    <div class="help-block"></div>
                            ...
                            {{-- <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="item form-group {{ $errors->has('passport') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control col-md-11 col-xs-12" name="passport_id" id="passport" value="{{ $student->passport_id ?? "" }}" placeholder="Passport Id" type="text" autocomplete="off">
                                    <div class="help-block"></div>
                            ...
                            {{-- <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="item form-group {{ $errors->has('photo') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control col-md-11 col-xs-12" name="photo" id="photo" type="file">
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <div class="item form-group">
                                    ...
                                    <input class="form-control col-md-11 col-xs-12" name="father_name" id="father_name" value="{{ $student->father_name ?? "" }}" placeholder="Father Name" type="text" autocomplete="off">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <div class="item form-group">
                                    ...
                                    <input class="form-control col-md-11 col-xs-12" name="father_profession" id="father_profession" value="{{ $student->father_profession ?? "" }}" placeholder="Father Profession" type="text" autocomplete="off">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <div class="item form-group">
                                    ...
                                    <input class="form-control col-md-11 col-xs-12" name="mother_name" id="mother_name" value="{{ $student->mother_name ?? "" }}" placeholder="Mother Name" type="text" autocomplete="off">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <div class="item form-group">
                                    ...
                                    <input class="form-control col-md-11 col-xs-12" name="mother_profession" id="mother_profession" value="{{ $student->mother_profession ?? "" }}" placeholder="Mother Profession" type="text" autocomplete="off">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                        </div>
