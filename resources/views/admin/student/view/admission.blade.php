                                                               ...
                                                               <div class="col-md-6 col-sm-12 col-xs-2">
                                                                ...
                                                                <div class="col-md-6 col-sm-12 col-xs-12">
                                                                    <div class="item form-group {{ $errors->has('country') ? ' has-error' : '' }}">
                                                                        ...
                                                                        @php
                                                                            $country = App\StudentInterestCountry::where('student_id',$student->id)->where('adminssion_status',1)->first()->country;
                                                                ...
                                                                <div class="col-md-6 col-sm-12 col-xs-12">
                                                                    <div class="item form-group {{ $errors->has('university') ? ' has-error' : '' }}">
                                                                        ...
                                                                        @php
                                                                        $university = App\StudentInterestCountry::where('student_id',$student->id)->where('adminssion_status',1)->where('country_id',$country->id)->first()->university;
                                                                        @endphp
                                                                ...
                                                                <div class="col-md-6 col-sm-12 col-xs-12">
                                                                    <div class="item form-group {{ $errors->has('course_category') ? ' has-error' : '' }}">
                                                                        ...
                                                                        @php
                                                                        $category = App\StudentInterestCountry::where('student_id',$student->id)->where('adminssion_status',1)->where('country_id',$country->id)->where('university_id', $university->id)->first()->coursecategory;
                                                                        @endphp
                                                                ...
                                                                <div class="col-md-6 col-sm-12 col-xs-12">
                                                                    <div class="item form-group {{ $errors->has('course') ? ' has-error' : '' }}">
                                                                        ...
                                                                        @php
                                                                        $course = App\StudentInterestCountry::where('student_id',$student->id)->where('adminssion_status',1)->where('country_id',$country->id)->where('university_id', $university->id)->first()->course;
                                                                        @endphp
                                                                ...
                                                                <div class="col-md-6 col-sm-12 col-xs-12">
                                                                    <div class="item form-group {{ $errors->has('reg_fees') ? ' has-error' : '' }}">
                                                                        ...
                                                                        <input class="form-control col-md-12 col-xs-12" name="reg_fees" id="reg_fees"  placeholder="Reg fees" type="text" value="{{ $country->reg_fees }}">
                                                                        <div class="help-block"></div>
                                                                ...
                                                                <div class="col-md-6 col-sm-12 col-xs-12">
                                                                    <div class="item form-group {{ $errors->has('tution_fees') ? ' has-error' : '' }}">
                                                                        @php
                                                                            $tution = App\UniversityWiseProgram::where('university',$university->id)->where('program',$course->id)->where('category',$category->id)->first();
                                                                        @endphp
                                                                        <label for="tution_fees">Tution Fees (Per S/Y)<span class="required">*</span>
                                                                        </label>
                                                                        <input class="form-control col-md-12 col-xs-12" name="tution_fees" id="tution_fees"  placeholder="Tution Fees" type="text" value="{{ $tution->tution_fees }}">
                                                                        <div class="help-block"></div>
                                                                ...
                                                                <div class="col-md-6 col-sm-12 col-xs-12">
                                                                    <div class="item form-group {{ $errors->has('total_course_fees') ? ' has-error' : '' }}">
                                                                        ...
                                                                        <input class="form-control col-md-12 col-xs-12" name="total_course_fees" id="total_course_fees"  placeholder="Totall Course Fees" value="{{ $tution->total_tution_fees }}">
                                                                        <div class="help-block"></div>
