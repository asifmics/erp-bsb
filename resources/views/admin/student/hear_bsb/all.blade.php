...
<div class="kt-portlet kt-portlet--mobile">
	<div class="kt-portlet__head kt-portlet__head--lg">
      ...
      <span class="kt-portlet__head-icon"><i class="fab fa-gg-circle"></i></span>
			<h3 class="kt-portlet__head-title">All Media Information</h3>
		</div>
		<div class="kt-portlet__head-toolbar">
			<div class="kt-portlet__head-wrapper">
				<div class="kt-portlet__head-actions">

					<a href="{{route('add_hear_bsb')}}" class="btn btn-brand btn-elevate btn-icon-sm"><i class="fa fa-plus-circle"></i>Add Media</a>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<a href="{{route('edit_hear_bsb', $media->id)}}" class="text-info" title="edit"><i class="fa fa-pen-square fa-2x"></i></a>

						<a href="{{route('delete_hear_bsb', $media->id)}}" class="text-danger manage_btn_icon" ><i class="fa fa-trash"></i></a>
