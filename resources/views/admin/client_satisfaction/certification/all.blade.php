...
<div class="kt-portlet kt-portlet--mobile">
	<div class="kt-portlet__head kt-portlet__head--lg">
      ...
      <span class="kt-portlet__head-icon"><i class="fab fa-gg-circle"></i></span>
			<h3 class="kt-portlet__head-title">All Certification Agent</h3>
		</div>
		<div class="kt-portlet__head-toolbar">
			<div class="kt-portlet__head-wrapper">
				<div class="kt-portlet__head-actions">

					<a href="{{ url('dashboard/certification/agent') }}" class="btn btn-brand btn-elevate btn-icon-sm"><i class="fa fa-plus-circle"></i>Add Certification</a>
			...
			<tbody>
				...
				<tr>
                    ...
                    @endif--}}
						...
						<a href='{{url("dashboard/certification/agent/$item->slug")}}' class="text-info" title="edit"><i class="fa fa-pen-square fa-lg ml-1"></i></a>

						<a href='#'x id="softDelete" class="text-danger manage_btn_icon" title="delete" data-toggle="modal" data-target="#softDelModal" data-id="{{$item->id}}"><i class="fa fa-trash fa-sm ml-1"></i></a>
