...
<div class="kt-portlet kt-portlet--mobile">
    <form class="kt-form kt-form--label-right" method="post" action="{{ url("dashboard/international/agent/$agent->slug/edit") }}"
        ...
        <div class="kt-portlet__body">
                    ...
                    <div class="col-md-7">
                        ...
                        <select id="inst_select_div" class="form-control" name="university_id" required>
                            @foreach ( $country->universities as $university)
                                <option value="{{ $university->id }}" {{ $agent->university_id == $university->id ? 'selected'  : ''}} >{{ $university->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="form-group row ">
                ...
                <select class="form-control" name="certification_id" >
                    ...
                    <option value="{{ $certificate->id }}" {{ $agent->certification_id == $certificate->id ? "selected" : ''}}>{{ $certificate->name }}</option>
                    @endforeach
                ...
                <div class="col-md-7">
                    ...
                    <select class="form-control" name="type" >
                        <option value="">Select Agent Type</option>
                            <option value="1" {{ $agent->type == 1 ? "selected" : ''}} >Direct</option>
                            <option value="2" {{ $agent->type == 2 ? "selected" : ''}} >Indirect</option>
            ...
            <div class="form-group row ">
                ...
                <div class="col-md-7">
                    <div class="input-group date">
                        <input type="text" class="form-control" readonly="readonly" name="valid_form" value="{{ old('valid_form') ?? $agent->valid_form ?? Carbon\Carbon::now()->format('d/m/Y')}}" id="kt_datepicker_3">
            ...
            <div class="form-group row ">
                ...
                <div class="col-md-7">
                    <div class="input-group date valid_to">
                        <input type="text" class="form-control" readonly="readonly" name="valid_to" value="{{ old('valid_to') ?? $agent->valid_to ?? Carbon\Carbon::now()->format('d/m/Y')}}" id="kt_datepicker_3">
                        <div class="input-group-append">	<span class="input-group-text">
                        <i class="la la-calendar"></i>
                        </span>
                        </div>
            ...
            <div class="form-group row ">
                ...
                <div class="col-md-7">
                    <div class="input-group date received_by">
                        <textarea style="height: 200px" type="text" class="form-control" name="contact_details">{{ $agent->contact_details ?? '' }}</textarea>
                    </div>
            ...
            <div class="form-group row ">
                ...
                <div class="col-md-7">
                    <div class="input-group date remark">
                        <textarea style="height: 200px" type="text" class="form-control" name="remark">{{ $agent->remark ?? '' }}</textarea>
                    </div>
            ...
            <div class="form-group row ">
                ...
                <div class="col-md-7">
                    ...
                    @endif
                    <a style="line-height: 50px"  href='{{ asset("uploads/agent/$agent->pdf_file") }}'><i style="font-size: 20px" class="fa fa-file-pdf"></i></a>
                </div>
            </div>
