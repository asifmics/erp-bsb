...
@section('content')
    ...
    <div class="kt-portlet kt-portlet--mobile">
        <form class="kt-form kt-form--label-right" method="post" action='{{ url("dashboard/international/admission/visa/$internationalStudentVisa->slug/edit") }}'
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12 ">
                                    <div class="admission-address">
                                        ...
                                        <div>
                                            <h4 class="text-center">Edit Record Of International Student Admission Visa </h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="item form-group  {{ $errors->has('student_id') ? ' has-error' : '' }}">
                                        ...
                                        <select class="form-control kt-select2 studentChooseId" id="kt_select2_1" name="student_id" >
                                                ...
                                                <option value="{{ $internationalStudentVisa->student_id}}" >{{$internationalStudentVisa->student->id_no . ' / ' . ( $internationalStudentVisa->student->name) }}  </option>
                            ...
                            <div class="form-part">
                                <div class="row">
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item form-group ">
                                            ...
                                            <input class="form-control col-md-10 col-xs-12"  readonly id="" value="{{ $internationalStudentVisa->student->counsellorganerate->name ?? '' }}" placeholder=""  autocomplete="off">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-10 col-xs-12" readonly  id="student_name" value="{{ $internationalStudentVisa->student->name ?? ''  }}" placeholder="ID number" type="text" autocomplete="off" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;">
                                            <div class="help-block"></div>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item form-group ">
                                            ...
                                            <input class="form-control col-md-10 col-xs-12"   readonly id="phone_number" value="{{ $internationalStudentVisa->student->phone ?? '' }}" placeholder=""  autocomplete="off">
                                            <div class="help-block"></div>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item form-group ">
                                            ...
                                            <input class="form-control col-md-10 col-xs-12"   readonly id="country_name" value="{{ $internationalStudentVisa->student->country->name ?? '' }}" placeholder=""  autocomplete="off">
                                            <div class="help-block"></div>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item form-group {{ $errors->has('offer_letter_form') ? ' has-error' : '' }}">
                                            ...
                                            <input class="form-control col-md-10 col-xs-12" name="offer_letter_form"  id="offer_letter_form" value="{{ $internationalStudentVisa->offer_letter_form ?? '' }}" placeholder=""  autocomplete="off">
                                            <div class="help-block"></div>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item form-group {{ $errors->has('admission_on_pro') ? ' has-error' : '' }}">
                                            ...
                                            <input class="form-control col-md-10 col-xs-12" name="admission_on_pro" id="admission_on_pro" value="{{ $internationalStudentVisa->admission_on_pro ?? '' }}" placeholder=""  autocomplete="off">
                                            <div class="help-block"></div>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item form-group {{ $errors->has('overseas') ? ' has-error' : '' }}">
                                            ...
                                            <input class="form-control col-md-10 col-xs-12" id="kt_datepicker_1" name="overseas"  value="{{ $internationalStudentVisa->overseas ?? '' }}" placeholder="dd-mm-yy" type="text" autocomplete="off">
                                            <div class="help-block"></div>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item form-group {{ $errors->has('submit_on') ? ' has-error' : '' }}">
                                            ...
                                            <input class="form-control col-md-10 col-xs-12" id="kt_datepicker_1" name="submit_on"  value="{{ $internationalStudentVisa->submit_on ?? '' }}" placeholder="dd-mm-yy" type="text" autocomplete="off">
                                            <div class="help-block"></div>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item form-group {{ $errors->has('notary_on') ? ' has-error' : '' }}">
                                            ...
                                            <input class="form-control col-md-10 col-xs-12" id="kt_datepicker_1" name="notary_on"  value="{{ $internationalStudentVisa->notary_on ?? '' }}" placeholder="dd-mm-yy" type="text" autocomplete="off">
                                            <div class="help-block"></div>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item form-group {{ $errors->has('received_no') ? ' has-error' : '' }}">
                                            ...
                                            <input class="form-control col-md-10 col-xs-12" id="kt_datepicker_1" name="received_no"  value="{{ $internationalStudentVisa->received_no ?? '' }}" placeholder="dd-mm-yy" type="text" autocomplete="off">
                                            <div class="help-block"></div>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item form-group {{ $errors->has('appointment_on') ? ' has-error' : '' }}">
                                            ...
                                            <input class="form-control col-md-10 col-xs-12" id="kt_datepicker_1" name="appointment_on"  value="{{ $internationalStudentVisa->appointment_on ?? '' }}" placeholder="dd-mm-yy" type="text" autocomplete="off">
                                            <div class="help-block"></div>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item form-group {{ $errors->has('file_submit_on') ? ' has-error' : '' }}">
                                            ...
                                            <input class="form-control col-md-10 col-xs-12" id="kt_datepicker_1" name="file_submit_on"  value="{{ $internationalStudentVisa->file_submit_on ?? '' }}" placeholder="dd-mm-yy" type="text" autocomplete="off">
                                            <div class="help-block"></div>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="item form-group {{ $errors->has('remark') ? ' has-error' : '' }}">
                                            ...
                                            <textarea style="height: 150px" class="form-control col-md-12 col-xs-12" name="remark" >{{ $internationalStudentVisa->remark ?? '' }}</textarea>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="item form-group {{ $errors->has('laps') ? ' has-error' : '' }}">
                                            ...
                                            <textarea style="height: 150px" class="form-control col-md-12 col-xs-12" name="laps" >{{ $internationalStudentVisa->laps }}</textarea>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="checkbox checkbox-outline checkbox-success">Active
                                                <input id="" class="ml-2 " value="1" type="checkbox" name="status" style="position: absolute; top: 4px;" {{ !empty( $internationalStudentVisa->status ) ? 'checked' : '' }} >
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 margin-top text-center">
                                        <button type="submit" class="btn btn-info glbscl-link-btn hvr-bs">Update International Student Admission</button>
                                    </div>
                                </div>
                            </div>
