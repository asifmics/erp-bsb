...
<div class="kt-portlet kt-portlet--mobile">
	<div class="kt-portlet__head kt-portlet__head--lg">
      ...
      <span class="kt-portlet__head-icon"><i class="fab fa-gg-circle"></i></span>
			<h3 class="kt-portlet__head-title">All Ads</h3>
	</div>
    <div class="kt-portlet__head-toolbar">
        <div class="kt-portlet__head-wrapper">
            <div class="kt-portlet__head-actions">
                @can('insert_advertisment')
                <a href="{{route('add_ads')}}" class="btn btn-brand btn-elevate btn-icon-sm"><i class="fa fa-plus-circle"></i>Add Ads</a>
                @endcan
            </div>
        </div>
    </div>
		...
		<table class="table table-striped- table-bordered table-hover table-checkable custom_table" id="alltableinfo">
			...
			<tbody>
				...
				<tr>
					...
					<td>{{ $item->cost}}</td>
					<td>
                        @can('view_advertisment')
						<a href="{{route('view_ads', $item->id)}}" class="text-info" title="edit"><i class="fa fa-eye fa-2x"></i></a>
                        @endcan
                        @can('edit_advertisment')
						<a href="{{route('edit_ads', $item->id)}}" class="text-info" title="edit"><i class="fa fa-pen-square fa-2x"></i></a>
                        @endcan
                        @can('delete_advertisment')
